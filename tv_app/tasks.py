...
def reset_clicks():
    ...
    with app.app_context():
        try:
            ...
            # The TTL is a safety net if Redis is unavailable during the
            # scheduled reset. SQL ``clicks`` remains a durable diagnostic
            # counter; it is no longer the live popularity source.
